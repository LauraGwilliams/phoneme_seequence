...
expInfo = {'Subject ID': 'ECXXX', 'TDT Block': 'BXX', 'block_type': '1'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/lauragwilliams/Dropbox (UCSF Department of Neurological Surgery)/lg/lexical_access/new_task/sequence/sequence-1_lastrun.py',
