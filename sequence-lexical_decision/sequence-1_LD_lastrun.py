...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/lauragwilliams/Dropbox (UCSF Department of Neurological Surgery)/lg/lexical_access/new_task/sequence-lexical_decision/sequence-1_LD_lastrun.py',
